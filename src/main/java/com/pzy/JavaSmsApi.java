...
public class JavaSmsApi {
	...
	public static boolean sendSms(String phoneNumber, String text) {
		...
		try {
			System.out.println(JavaSmsApi.sendSms(apikey, text, phoneNumber));
			result = true;
		} catch (IOException e) {
			// TODO Auto-generated catch block
			System.err.println("发送短信失败: " + e.getMessage());
			try {
				System.out.println("账户信息：" + JavaSmsApi.getUserInfo(apikey));
	...
	public static void main(String[] args) throws IOException,
		...
		String text = "[天气简报]日期=2016-6-5, 天气=多云转晴, 最高气温=33℃, 最低气温=19,风力=微风, 风向=东风[晴]";
		// 发短信调用示例
